...
You can find our trained model in the \ml-model folder in both .pb and .mlmodel format. In the same file you can find a way to convert our previously trained model in .pb to a .mlmodel file. To use it you will have to clone the following repo
